...
export namespace PERMISSIONS {
    ...
    namespace READ_ENCRYPTED {
        let description_1: string;
        export { description_1 as description };
        let value_1: number;
        export { value_1 as value };
    }
    namespace READ_ENCRYPTED_MITM {
    ...
    namespace WRITE_ENCRYPTED {
        let description_4: string;
        export { description_4 as description };
        let value_4: number;
        export { value_4 as value };
    }
    namespace WRITE_ENCRYPTED_MITM {
        let description_5: string;
        export { description_5 as description };
        let value_5: number;
        export { value_5 as value };
    }
    namespace WRITE_SIGNED {
        let description_6: string;
        export { description_6 as description };
        let value_6: number;
        export { value_6 as value };
    }
    namespace WRITE_SIGNED_MITM {
        let description_7: string;
        export { description_7 as description };
        let value_7: number;
        export { value_7 as value };
    }
    namespace READ_DESCRIPTOR {
        let description_8: string;
        export { description_8 as description };
        let value_8: number;
        export { value_8 as value };
    }
    namespace WRITE_DESCRIPTOR {
        let description_9: string;
        export { description_9 as description };
        let value_9: number;
        export { value_9 as value };
    }
    namespace READ_WRITE_DESCRIPTOR {
